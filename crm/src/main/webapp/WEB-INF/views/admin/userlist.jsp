                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right" style="margin-bottom:15px ">
                                <a href="javascript:;" id="newBtn" class="btn btn-md btn-success"><i
                ...
                },
                {
                    "data": function (row) {
                        if (row.username=='admin'){
                            ...
                            return '<a href="javascript:;"class="resetPwd" rel="'+row.id+'">重置密码</a>&nbsp;&nbsp;<a href="javascript:;"class="edit" rel="'+row.id+'">修改信息</a>';
                        }
                    }
                }
            ],
